class ExcelObservation(object):
    ...
    def __init__(self, iso3=None, indicator_code=None, value=None, year=None, ranking=None, scaled=None):
        self._iso3 = iso3
    ...
    def __str__(self):
        ...
        self.iso3, self.indicator_code, self.year, self.value, self.scaled, self.ranking)
